...
class UpdateELearningCourseRequest extends FormRequest
{
    /**
    ...
    {
        return auth()->user()->can('update e-learning course');
    }
    ...
    protected function failedAuthorization()
    {
        throw new AuthorizationException(
            'You are not authorised to update a an E - Learning Course'
        );
    }
}
