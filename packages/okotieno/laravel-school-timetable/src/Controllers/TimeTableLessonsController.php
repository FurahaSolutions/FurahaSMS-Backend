...
use Okotieno\TimeTable\Requests\StoreTimeTableLessonRequest;
...
class TimeTableLessonsController extends Controller
{
  ...
  public function store(AcademicYear $academicYear, TimeTable $timeTable, StoreTimeTableLessonRequest $request)
  {
